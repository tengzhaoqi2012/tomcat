...
public class CoyoteAdapter implements Adapter {
    ...
    public void service(org.apache.coyote.Request req, 
        ...
        try {
            ...
            if (postParseRequest(req, request, res, response)) {
                // Calling the container
                //connector.getcontainer()为StandardEngine
            	//connector.getContainer().getPipeline()为org.apache.catalina.core.StandardPipeline
            	//connector.getContainer().getPipeline().getFirst()为org.apache.catalina.core.StandardEngineValve
    ...
    /**
     * 为req设置schema,为request设置是否为secure
    ...
    /**
     * 看看req的请求url里有没有sessionid,如果有的话，给request设上;如果没有设空.
            ...
            try {
                if (semicolon2 >= 0) {
                    request.setRequestedSessionId
                        (new String(uriBC.getBuffer(), start + sessionIdStart, semicolon2 - sessionIdStart, enc));
