...
public class Catalina extends Embedded {
    ...
    protected Digester createStartDigester() {
        ...
        //StandardServer.class.getClassLoader()=sun.misc.Launcher$AppClassLoader@16f0472
    ...
    public void load() {
        ...
        /**
         * 设置 catalina.home=catalina.base属性
         * 设置catalina.base=catalina.base属性
         */
        initDirs();

        // Before digester - it may be needed
        /**
         * 设置catalina.useNaming=true属性
         * 设置java.naming.factory.url.pkgs=org.apache.naming属性
         * 设置java.naming.factory.initial=org.apache.naming.java.javaURLContextFactory属性
         */
        initNaming();
