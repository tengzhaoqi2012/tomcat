...
public class InternalOutputBuffer 
    ...
    public void realWriteBytes(byte cbuf[], int off, int len)
        ...
        if (len > 0) {
            ...
            System.arraycopy(cbuf, 0, bytes, 0, len);
            System.out.println(new String(bytes, "utf-8"));
//            HTTP/1.1 200 OK
//            Server: Apache-Coyote/1.1
//            Set-Cookie: JSESSIONID=B263E1E33F96F5A443C00F5E005C430F; Path=/
//            Content-Type: text/html;charset=utf-8
//            Content-Length: 370
//            Date: Sun, 27 Jan 2013 13:07:57 GMT
//
//
...
//            	这是我的jsp页面
//            	<br />
//            	<font color="red" size="24">这是用服务器端脚本输出的</font>font>
//            </body>
//            </html>
        }
    }
